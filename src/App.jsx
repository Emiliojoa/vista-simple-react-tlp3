    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 bg-white/5 backdrop-blur-lg rounded-2xl p-8 shadow-xl">
          <h1 className="text-5xl font-bold text-green-400 mb-4">Rick and Morty Universe</h1>
          <p className="text-xl text-gray-300 mb-8">Total Characters: {data?.info?.count}</p>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <span className="text-gray-400 min-w-[4.5rem]">Status:</span>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-gray-400 min-w-[4.5rem]">Species:</span>
                    <span className="text-gray-300">{character.species}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-gray-400 min-w-[4.5rem]">Origin:</span>
